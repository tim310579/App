...
public class Edit_user_profile extends AppCompatActivity {
    ...
    private Button edit_OK, male, female, Back_home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if(gv.getport()!=0) mEdit_port.setText(" "+gv.getport());
    ...
    class edit_OK extends Thread {
        ...
        public void run() {
            ...
            /*if (TextUtils.isEmpty(mEdit_ip.getText())){ ip = "140.113.66.153"; }// ID is null
            else ip = mEdit_ip.getText().toString();
            if (TextUtils.isEmpty(mEdit_port.getText())){ port = "8787"; }// ID is null
            else port = mEdit_port.getText().toString();*/
