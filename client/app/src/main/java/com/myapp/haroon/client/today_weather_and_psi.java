...
public class today_weather_and_psi extends AppCompatActivity {
    ...
    public TextView tv_PM25, tv_PM10, tv_SO2, tv_NOx, tv_CO, tv_O3;
        ...
        public void run() {
            ...
            try {
                ...
                if(miss_user_data.compareTo(response) == 0){
                    ...
                    tv_psi.setText(" " + psi);
                    tv_PM25.setText(" " + PM25 + " μg/m3");
                    tv_PM10.setText(" " + PM10 + " μg/m3");
                    tv_SO2.setText(" " + SO2 + " ppb");
                    tv_NOx.setText(" " + NOx + " ppb");
                    tv_CO.setText(" " + CO + " ppm");
                    tv_O3.setText(" " + O3 + " ppb");
