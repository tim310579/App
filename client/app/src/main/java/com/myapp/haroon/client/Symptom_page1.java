...
public class Symptom_page1 extends AppCompatActivity {
    ...
    final String[] night_symptoms = {"請選擇", "正常", "輕微", "中度", "嚴重"};
    final String[] day_symptoms = {"請選擇", "正常", "輕微", "中度", "嚴重", "需急診治療"};
    final String[] nose_symptom1s = {"請選擇", "正常", "輕微", "中度以上"};
    final String[] nose_symptom2s = {"請選擇", "正常", "輕微", "中度以上"};
    final String[] nose_symptom3s = {"請選擇", "正常", "輕微", "中度以上"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_night_symptom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String tmp = "請";
                if (position == 0) {
                    if(tmp.compareTo(night_symptoms[position].substring(0, 1))==0) {   //1st & no choose
                        night_symptom = night_symptoms[position].substring(0, 1);
                    }
                }
                else { night_symptom = Integer.toString(position-1);}
                //night_symptom = night_symptoms[position].substring(0, 1);
        ...
        spinner_day_symptom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String tmp = "請";
                if (position == 0) {
                    if(tmp.compareTo(day_symptoms[position].substring(0, 1))==0) {   //1st & no choose
                        day_symptom = day_symptoms[position].substring(0, 1);
                    }
                }
                else { day_symptom = Integer.toString(position-1);}
                //day_symptom = day_symptoms[position].substring(0, 1);
                //Toast.makeText(.this, "您選擇了:" + lunch[position], Toast.LENGTH_SHORT).show();
            }
            @Override
        ...
        spinner_nose_symptom1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String tmp = "請";
                if (position == 0) {
                    if(tmp.compareTo(nose_symptom1s[position].substring(0, 1))==0) {   //1st & no choose
                        nose_symptom1 = nose_symptom1s[position].substring(0, 1);
                    }
                }
                else { nose_symptom1 = Integer.toString(position-1);}
                //nose_symptom1 = nose_symptom1s[position].substring(0, 1);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {}
        ...
        spinner_nose_symptom2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String tmp = "請";
                if (position == 0) {
                    if(tmp.compareTo(nose_symptom2s[position].substring(0, 1))==0) {   //1st & no choose
                        nose_symptom2 = nose_symptom2s[position].substring(0, 1);
                    }
                }
                else { nose_symptom2 = Integer.toString(position-1);}
                //nose_symptom2 = nose_symptom2s[position].substring(0, 1);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {}
        ...
        spinner_nose_symptom3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String tmp = "請";
                if (position == 0) {
                    if(tmp.compareTo(nose_symptom3s[position].substring(0, 1))==0) {   //1st & no choose
                        nose_symptom3 = nose_symptom3s[position].substring(0, 1);
                    }
                }
                else { nose_symptom3 = Integer.toString(position-1);}
                //nose_symptom3 = nose_symptom3s[position].substring(0, 1);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {}
