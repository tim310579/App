...
public class GlobalVariable extends Application{
    ...
    private String PM25, PM10, SO2, NOx, CO, O3;
    private String more_notice;
    ...
    public void setmore_notice(String more_notice){ this.more_notice = more_notice; }
    ...
    public void setNOx(String NOx){ this.NOx = NOx; }
